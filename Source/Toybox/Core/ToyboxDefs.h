...
enum KeyMap
{
    ...
    KM_VEHICLE_ROT_X_INC = 1 << 2,
    KM_VEHICLE_ROT_X_DEC = 1 << 3,

    KM_VEHICLE_THRUST_Y_INC = 1 << 4,
    KM_VEHICLE_THRUST_Y_DEC = 1 << 5,
    KM_VEHICLE_ROT_Y_INC = 1 << 6,
    KM_VEHICLE_ROT_Y_DEC = 1 << 7,

    KM_VEHICLE_THRUST_Z_INC = 1 << 8,
    KM_VEHICLE_THRUST_Z_DEC = 1 << 9,
    KM_VEHICLE_THRUST_Z_MAX = 1 << 10,
    KM_VEHICLE_THRUST_Z_STOP = 1 << 11,
    KM_VEHICLE_ROT_Z_INC = 1 << 12,
    KM_VEHICLE_ROT_Z_DEC = 1 << 13,
